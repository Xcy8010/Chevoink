...
const ERRORS: Record<string, string> = {
  ...
  IMPORT_ACTIVE_JOB_EXISTS: '当前作品已有未完成导入，请从导入记录恢复或明确取消原任务后再新建。',
  IMPORT_ROUTING_SOURCE_REQUIRED: '旧预览的计划或记忆没有来源定位，请重新解析原文件后再排除，避免误导入。',
  IMPORT_REVIEW_INVALID: '此来源缺失或解析失败，不能标记为已复核。请重新解析或明确排除该来源；其余内容可继续核对。',
